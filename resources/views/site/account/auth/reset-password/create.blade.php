                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form method="post" action="{{ route('site.account.auth.reset-password.store') }}">
                                    ...
                                    <div class="form-group">
                                        <input name="password_confirmation" type="password" placeholder="Confirm Password" required autocomplete="off" class="form-control @error('password_confirmation') is-invalid @enderror">
