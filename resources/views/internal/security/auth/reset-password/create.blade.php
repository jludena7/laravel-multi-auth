                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{ route('internal.security.auth.reset-password.store') }}">
                                    ...
                                    <div class="form-group">
                                        <input name="password_confirmation" type="password" placeholder="Confirm Password" required class="form-control form-control-user @error('password_confirmation') is-invalid @enderror">
